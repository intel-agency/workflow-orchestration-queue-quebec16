...
app = FastAPI(
    ...
    description="Webhook receiver for OS-APOW orchestration events",
    version="0.1.0",
)
...
def main() -> None:
    """CLI entry point for the Notifier service."""
    import uvicorn

    # In dev, run with: uv run uvicorn os_apow.services.notifier:app --reload
